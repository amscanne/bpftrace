...
public:
  ...
  ScopedValue CreateAllocaBPFInit(const SizedType &stype,
                                  const std::string &name);
  ...
  // Functions which operate on the context.
  ...
  ScopedValue CreateGetStrAllocation(const std::string &name,
                                     const Location &loc);
  ScopedValue CreateGetFmtStringArgsAllocation(StructType *struct_type,
                                               const std::string &name,
                                               const Location &loc);
  ScopedValue CreateTupleAllocation(const SizedType &tuple_type,
                                    const std::string &name,
                                    const Location &loc);
  ScopedValue CreateWriteMapValueAllocation(const SizedType &value_type,
                                            const std::string &name,
                                            const Location &loc);
  ScopedValue CreateVariableAllocationInit(const SizedType &value_type,
                                           const std::string &name,
                                           const Location &loc);
  ScopedValue CreateMapKeyAllocation(const SizedType &value_type,
                                     const std::string &name,
                                     const Location &loc);
...
=======
  ...
  ScopedValue CreateGetPid(const Location &loc);
  ScopedValue CreateGetTid(const Location &loc);
  ScopedValue CreateGetPid(Value *ctx, const Location &loc);
  ScopedValue CreateGetTid(Value *ctx, const Location &loc);
...
private:
  ...
  ScopedValue CreateGetNsPidTgid(Value *ctx,
                                 Value *dev,
                                 Value *ino,
                                 const Location &loc);
  ...
  Value *CreateReadMapValueAllocation(const SizedType &value_type,
                                      const std::string &name,
                                      const Location &loc);
  ScopedValue createAllocation(std::string_view global_var_name,
                               llvm::Type *obj_type,
                               const std::string &name,
                               const Location &loc,

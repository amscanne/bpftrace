...
public:
  ...
  // offset from this pointer). This is required for the context pointer, which
  // cannot be modified. This method also automatically handles casts from
  // integers and other pointers; the output value is always a pointer to `ty`.
  //

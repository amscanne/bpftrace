                                    ...
                                    const Location &loc)
{
  ...
  BasicBlock *is_positive_block = BasicBlock::Create(module_.getContext(),
                                                     "is_positive",
                                                     parent);
  BasicBlock *non_positive_block = BasicBlock::Create(module_.getContext(),
                                                      "non_positive",
                                                      parent);
  Value *is_positive = CreateICmpSGT(iters, getInt32(0), "is_positive_cond");
  CreateCondBr(is_positive, is_positive_block, non_positive_block);
  SetInsertPoint(is_positive_block);
  ...
  SetInsertPoint(non_positive_block);
  return call;
}

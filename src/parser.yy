...
// Unambiguous unary operators (cannot be used as binary operators)
unary_operator:
        BNOT   { $$ = ast::Operator::BNOT; }
    |   LNOT   { $$ = ast::Operator::LNOT; }
        ;

// Ambiguous operators (can be either unary or binary)
ambiguous_operator:
        MUL    { $$ = ast::Operator::MUL; }    // Dereference or multiplication
    |   MINUS  { $$ = ast::Operator::MINUS; }  // Negation or subtraction
        ;
